...
mod tests {
    ...
    fn test_gps_time() {
        assert_eq!(
            GpsTime {
                content: 0b11010011_11111111_11111111_11111111_11111111_11111111_11111111_11111111
            }
            .years(),
            0b11010011
        );
        ...
        assert_eq!(
            GpsTime {
                content: 0b11111111_10101101_01111111_11111111_11111111_11111111_11111111_11111111
            }
            .days(),
            0b101011010
        );
        ...
        assert_eq!(
            GpsTime {
                content: 0b11111111_11111111_10101011_11111111_11111111_11111111_11111111_11111111
            }
            .hours(),
            0b01010
        );
        ...
        assert_eq!(
            GpsTime {
                content: 0b11111111_11111111_11111101_00101111_11111111_11111111_11111111_11111111
            }
            .minutes(),
            0b010010
        );
        ...
        assert_eq!(
            GpsTime {
                content: 0b11111111_11111111_11111111_11110100_10111111_11111111_11111111_11111111
            }
            .seconds(),
            0b010010
        );
        ...
        assert_eq!(
            GpsTime {
                content: 0b11111111_11111111_11111111_11111111_11010100_10101111_11111111_11111111
            }
            .milliseconds(),
            0b0101001010
        );
        ...
        assert_eq!(
            GpsTime {
                content: 0b11111111_11111111_11111111_11111111_11111111_11110101_00101011_11111111
            }
            .microseconds(),
            0b0101001010
        );
        ...
        assert_eq!(
            GpsTime {
                content: 0b11111111_11111111_11111111_11111111_11111111_11111111_11111101_01001010
            }
            .nanoseconds(),
            0b0101001010
        );
